...
inline v8::Local<v8::Value> v8_value(v8::Isolate *isolate, const std::string &str) {
...
inline v8::Local<v8::Value> v8_value(v8::Isolate *isolate, double value) {
  return v8::Number::New(isolate, value);  
}

inline v8::Local<v8::Value> v8_value(v8::Isolate *isolate, bool value) {
